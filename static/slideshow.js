...
styles.href="/static/slideshow.css";
document.head.appendChild(styles);
document.querySelector(slideshow.container).innerHTML = `
<div class="slideshow-info"></div>
<div class="slideshow-docs">Стрелки — для переключения слайдов.
<span>«Пробел» переключает автовоспроизведение.</span></div>
...
`;
var out = document.querySelector('.slideshow-info');
...
var autoplay = document.querySelector('#slideshow-autoplay');
var hash = 'counter' + slideshow.folder;
var counter = localStorage.getItem(hash)||0;
var autoincrease = slideshow.autoplay === 'no' ? false : true;
var restart = slideshow.endless === 'no' ? false : true;
var first = false;
var last = false;
var timeout = false;
var speed = slideshow.speed || 3000;
var all = slideshow.media.length
